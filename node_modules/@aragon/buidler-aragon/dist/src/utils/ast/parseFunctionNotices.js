...
exports.parseFunctionsNotices = void 0;
 ...
 * @return false
 */
const modifiesStateAndIsPublic = (declaration) => !declaration.match(/\b(internal|private|view|pure|constant)\b/);
/**
 ...
 * @return "address"
 */
const typeOrAddress = (type) => Object.keys(SOLIDITY_TYPES).some(t => type.startsWith(t)) ? type : 'address';
/**
 * Expand shorthands into their full types for calculating function signatures
 * @param type "uint"
 * @return "uint256"
 */
const expandTypeForSignature = (type) => type in SOLIDITY_TYPES ? SOLIDITY_TYPES[type] : type;
/**
 ...
 * @param declaration multiline function declaration with comments
 */
function getNotice(declaration) {
 ...
 * }, ... ]
 */
function parseFunctionsNotices(sourceCode) {
...
exports.parseFunctionsNotices = parseFunctionsNotices;
//# sourceMappingURL=parseFunctionNotices.js.map